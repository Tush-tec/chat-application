...
const GroupChatDetailsModal =  ({ open, onClose, chatId, onGroupDelete }) => {
  ...
  const removeParticipant = async (participantId) => {
    requestHandler(
      ...
      async () => await removeParticipantsToTheGroup(chatId, participantId),
  ...
  const addParticipant = async () => {
    ...
    requestHandler(
      ...
      async () => await addMembersToTheGroup(chatId, participantToBeAdded),
                                  ...
                                  <div className="flex justify-between items-center w-full py-4">
                                    ...
                                    {groupDetails.admin === user?._id ? (
                                      <div>
                                        <Button
                                          onClick={() => {
                                            const ok = window.confirm("Are you sure you want to remove " +user.username +" ?");
                                            if (ok) {
