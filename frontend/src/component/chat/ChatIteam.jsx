...
import {
  ...
  import { deleteOneOnOneChat } from "../../api/api";
  import { useAuth } from "../../context/AuthContext";
  import { classNames, getMetaDataOfChatObject, requestHandler } from "../../utils/index";
  import GroupChatDetailsModal from "./GroupChatModalDetails";   
        ...
        >
          ...
          >
            ...
            >
              {chat.isGroupChat ? (
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  const ok = window.confirm("Are you sure you want to delete this chat?"); // Correct usage of confirm()
                  if (ok) {
                    deleteChat();
                  }
                }}
          ...
          <div className="flex justify-center items-center flex-shrink-0">
            {chat.isGroupChat ? (
              ...
              <img
                src={getMetaDataOfChatObject(chat, user)?.avatar}
          ...
          <div className="w-full">
            <p className="truncate-1">
              {getMetaDataOfChatObject(chat, user)?.title}
            </p>
            <div className="w-full inline-flex items-center text-left">
              ...
              <small className="text-white/50 truncate-1 text-sm text-ellipsis inline-flex items-center">
                {getMetaDataOfChatObject(chat, user)?.lastMessage}
              </small>
            </div>
          </div>
